...
return (
    ...
    <nav 
        ...
        ${scrolled || isOpen 
            ? 'bg-altivea-blue/90 backdrop-blur-md py-4 shadow-lg border-b border-white/10' 
    ...
    >
        ...
        <Link href="/" className="flex items-center gap-2 group relative z-50">
            ...
            {/* Te dejé tu código original de Image aquí, asumiendo que tu logo está en la carpeta public */}
            <Image 
    ...
    `}>
        ...
        {/* Contenedor interno con pt-24 para que no choque con el logo/botón superior */}
        ...
        <Link 
            href="https://wa.me/51958176903"
            target="_blank"
            className="w-full bg-altivea-accent text-white py-4 rounded-xl font-bold text-lg text-center"
            onClick={() => setIsOpen(false)}
        >
            ¡Hablemos Ahora!
        </Link>
